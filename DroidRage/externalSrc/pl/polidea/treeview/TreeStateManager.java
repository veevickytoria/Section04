...
public interface TreeStateManager<T> extends Serializable {
	...
	// <ta>
	/**
	 * Set to false to prevent that changes are automatically reflected in the
	 * attached view. This will prevent exceptions when updating the tree in an
	 * AsyncTask The default is true, and calling notifyDataSetChanged() resets
	 * the flag to true.
	 */
