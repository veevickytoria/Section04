...
public class HmsPickerDialogFragment extends DialogFragment {
	 ...
	 * @return a Picker!
	 */
	public static HmsPickerDialogFragment newInstance(int reference,
			int themeResId) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.betterpickers_hms_picker_dialog,
				null);
		...
		mSet.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				for (HmsPickerDialogHandler handler : mHmsPickerDialogHandlers) {
					handler.onDialogHmsSet(mReference, mPicker.getHours(),
							mPicker.getMinutes(), mPicker.getSeconds());
				}
	 ...
	 */
	public void setHmsPickerDialogHandlers(
			Vector<HmsPickerDialogHandler> handlers) {
