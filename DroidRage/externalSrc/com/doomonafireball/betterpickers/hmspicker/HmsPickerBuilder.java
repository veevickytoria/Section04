...
public class HmsPickerBuilder {
	 ...
	 * @return the current Builder object
	 */
	public HmsPickerBuilder addHmsPickerDialogHandler(
			HmsPickerDialogHandler handler) {
	 ...
	 * @return the current Builder object
	 */
	public HmsPickerBuilder removeHmsPickerDialogHandler(
			HmsPickerDialogHandler handler) {
	...
	public void show() {
		...
		final HmsPickerDialogFragment fragment = HmsPickerDialogFragment
				.newInstance(mReference, styleResId);
