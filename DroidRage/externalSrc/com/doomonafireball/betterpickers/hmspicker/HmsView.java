...
public class HmsView extends LinearLayout {
	 ...
	 *            the Context in which to inflate the View
	 * @param attrs
	 *            attributes that define the title color
	 */
	 ...
	 *            the ones digit of the hours TextView
	 * @param minutesTensDigit
	 *            the tens digit of the minutes TextView
	 * @param minutesOnesDigit
	 *            the ones digit of the minutes TextView
	 * @param secondsTensDigit
	 *            the tens digit of the seconds TextView
	 * @param secondsOnesDigit
	 *            the ones digit of the seconds TextView
	 */
	public void setTime(int hoursOnesDigit, int minutesTensDigit,
			int minutesOnesDigit, int secondsTensDigit, int secondsOnesDigit) {
		if (mHoursOnes != null) {
