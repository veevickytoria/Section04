...
public class TimePickerBuilder {
	 ...
	 * @return the current Builder object
	 */
	public TimePickerBuilder addTimePickerDialogHandler(
	 ...
	 * @return the current Builder object
	 */
	public TimePickerBuilder removeTimePickerDialogHandler(
			TimePickerDialogHandler handler) {
	...
	public void show() {
		...
		final TimePickerDialogFragment fragment = TimePickerDialogFragment
