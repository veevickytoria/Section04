...
public class Utils {
	 ...
	 * 
	 * This assumes that the week containing the
	 * {@link android.text.format.Time#EPOCH_JULIAN_DAY} is considered week 0.
	 * It returns the Julian day for the Monday {@code week} weeks after the
	 * Monday of the week containing the epoch.
	 * 
	 * @param week
	...
	/**
	 * Returns the week since {@link android.text.format.Time#EPOCH_JULIAN_DAY}
	 * (Jan 1, 1970) adjusted for first day of week.
	 * 
	 * This takes a julian day and the week start day and calculates which week
	 * since {@link android.text.format.Time#EPOCH_JULIAN_DAY} that day occurs
	 * in, starting at 0. *Do not* use this to compute the ISO week number for
	 * the year.
	 * 
	 * @param julianDay
	 ...
	 *            {@link android.text.format.Time#SUNDAY}
	...
	public static ObjectAnimator getPulseAnimator(View labelToAnimate,
		...
		ObjectAnimator pulseAnimator = ObjectAnimator.ofPropertyValuesHolder(
				AnimatorProxy.NEEDS_PROXY ? AnimatorProxy.wrap(labelToAnimate)
