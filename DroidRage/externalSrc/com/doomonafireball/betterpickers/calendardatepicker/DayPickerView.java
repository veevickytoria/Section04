...
public class DayPickerView extends ListView implements OnScrollListener,
	...
	public static final int LIST_TOP_OFFSET = -1; // so that the top line will
													// be
	// under the separator
	...
	private SimpleMonthAdapter.CalendarDay findAccessibilityFocus() {
		...
		for (int i = 0; i < childCount; i++) {
			...
			if (child instanceof SimpleMonthView) {
				final SimpleMonthAdapter.CalendarDay focus = ((SimpleMonthView) child)
	...
	public boolean performAccessibilityAction(int action, Bundle arguments) {
		...
		SimpleMonthAdapter.CalendarDay day = new SimpleMonthAdapter.CalendarDay(
				year, month, 1);
