...
public class CalendarDatePickerDialog extends DialogFragment implements
	...
	public interface OnDateSetListener {
		 ...
		 */
		void onDateSet(CalendarDatePickerDialog dialog, int year,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(
				R.layout.betterpickers_calendar_date_picker_dialog, null);
		...
		mDoneButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				tryVibrate();
				if (mCallBack != null) {
					mCallBack.onDateSet(CalendarDatePickerDialog.this,
