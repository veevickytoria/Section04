...
public class SimpleMonthView extends View {
	 ...
	 * {@link android.text.format.Time#SUNDAY} through
	 ...
	 * {@link android.text.format.Time#month} [0-11].
	 */
	...
	public SimpleMonthView(Context context) {
		...
		mRowHeight = (res
				.getDimensionPixelOffset(R.dimen.date_picker_view_animator_height) - sMonthHeaderSize)
				/ MAX_NUM_ROWS;
	 ...
	 * 
	 * @Override public boolean onHoverEvent(MotionEvent event) { // First
	 * right-of-refusal goes the touch exploration helper. if
	 * (mNodeProvider.onHover(this, event)) { return true; } return
		...
		for (int i = 0; i < mNumDays; i++) {
			...
			canvas.drawText(
					mDayLabelCalendar.getDisplayName(Calendar.DAY_OF_WEEK,
							...
							Locale.getDefault()), x, y, mMonthDayLabelPaint);
		}
	}
	...
	protected void drawMonthNums(Canvas canvas) {
		...
		for (int dayNumber = 1; dayNumber <= mNumCells; dayNumber++) {
			...
			if (mSelectedDay == dayNumber) {
				canvas.drawCircle(x, y - (sMiniDayNumberTextSize / 3),
						sDaySelectedCircleSize, mSelectedCirclePaint);
			}
