...
public abstract class TouchExplorationHelper<T> extends
...
/* Removed for backwards compatibility to GB implements View.OnHoverListener */{
	...
	public TouchExplorationHelper(Context context, View parentView) {
		mManager = (AccessibilityManager) context
	...
	public AccessibilityNodeInfoCompat createAccessibilityNodeInfo(
		...
		final AccessibilityNodeInfoCompat node = AccessibilityNodeInfoCompat
				.obtain();
	...
	public boolean performAction(int virtualViewId, int action, Bundle arguments) {
		if (virtualViewId == View.NO_ID) {
			return ViewCompat.performAccessibilityAction(mParentView, action,
					arguments);
		}
	...
	private AccessibilityEvent getEventForItem(T item, int eventType) {
		...
		if (event.getText().isEmpty()
				&& TextUtils.isEmpty(event.getContentDescription())) {
	...
	private AccessibilityNodeInfoCompat getNodeForParent() {
		final AccessibilityNodeInfoCompat info = AccessibilityNodeInfoCompat
				.obtain(mParentView);
	...
	private final AccessibilityDelegateCompat mDelegate = new AccessibilityDelegateCompat() {
		@Override
		public void onInitializeAccessibilityEvent(View view,
	 ...
	 */
	protected abstract void populateEventForItem(T item,
			AccessibilityEvent event);
	 ...
	 */
	protected abstract void populateNodeForItem(T item,
			AccessibilityNodeInfoCompat node);
