...
public class Agenda implements IJSONObject<Agenda>, Parcelable {
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeList(getTopics());
		dest.writeString(getAttachedMeetingID());
	...
	private void readFromParcel(Parcel in) {
		...
		this.topics = in.readArrayList(Topic.class.getClassLoader());
		this.attachedMeetingID = in.readString();
