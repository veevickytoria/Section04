...
import edu.meetingninja.rhit.meetings.MeetingsFragment;
import edu.meetingninja.rhit.notes.CreateNoteActivity;
import edu.meetingninja.rhit.notes.NotesFragment;
import edu.meetingninja.rhit.schedule.ScheduleAdapter;
import edu.meetingninja.rhit.tasks.TasksFragment;
import edu.meetingninja.rhit.user.LoginActivity;
import edu.meetingninja.rhit.user.ProfileFragment;
import edu.meetingninja.rhit.user.SessionManager;
import edu.meetingninja.rhit.user.UserListFragment;
