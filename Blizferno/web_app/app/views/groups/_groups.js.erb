  ...
  function submitEditModal(){
    // REPLACE WITH: code to submit update request to DB
  }
  ...
  function showEditModal(){
    ...
    $.ajax({
      type: 'GET',
      url: 'http://csse371-04.csse.rose-hulman.edu/Groups/' + currentID,
      success:function(data){
        alert('inside');
      }
    })
  ...
  /* DOCUMENTATION FOR POPULATESELECT
    Populates the select tage specified by 'selectID'
